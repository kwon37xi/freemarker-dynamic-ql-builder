...
public class EnumToNameParameterConverterDynamicQueryTest extends AbstractFreemarkerDynamicQlBuilderTest {
    private Logger log = getLogger(EnumToNameParameterConverterDynamicQueryTest.class);
    ...
    public void boolean_to_string_converter() throws Exception {
        DynamicQuery dynamicQuery = processTemplate("parameterconverter/enum_to_name");
        ...
        assertThat(queryParameters.get(1), is((Object) "FULLTIME"));
        assertThat(queryParameters.get(2), is((Object) "PARTTIME"));
    }
}